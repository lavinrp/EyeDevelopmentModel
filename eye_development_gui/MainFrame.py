...
class MainFrame(MainFrameBase):
    ...
    def on_save(self, event: wx.Event):
        """
        Callback invoked whenever a user save an epithelium (via save or save as).
        Saves the active epithelium to the active file.
        ...
        export_epithelium(self.active_epithelium, self.active_file)

        # do not consume event
        event.Skip()

    def on_save_as(self, event: wx.Event):
        """
        ...
        self.active_file = save_as_dialog.GetFilename()
    ...
    def on_load(self, event: wx.Event):
        """
        Callback that is invoked whenever a user clicks the load button.
        ...
        # load the file
        self.active_file = load_dialog.GetFilename()
        self.active_epithelium = import_epithelium(self.active_file)
