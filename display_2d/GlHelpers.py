...
def world_coord_from_window_coord(window_coord: list,
                                  ...
                                  model_view_projection_matrix: numpy.ndarray) -> list:
    """
    ...
    :param model_view_projection_matrix: The model view projection matrix being used to draw the world.
    ...
    inverse_model_view_projection_matrix = matrix44.inverse(model_view_projection_matrix)
